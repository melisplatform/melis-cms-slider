...
const MELIS_KEY = 'MelisCmsSlider_left_menu' // rendable zone (follow_regular_rendering:false)
const FRAME_ID = 'melis-brick-frame-slider'  // unique per brick

/**
 * Renders the legacy MelisCmsSlider tool in an iframe via the shared loading mechanism

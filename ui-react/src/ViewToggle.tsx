...
// `compact` (opt-in, défaut false) : masque les libellés et ne garde que les icônes — utilisé sur
// mobile, où la barre d'en-tête n'a pas la place. Les autres appelants ne bougent pas.
